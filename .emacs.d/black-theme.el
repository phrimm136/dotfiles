...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-warning-face ((,class (:foreground ,warning :background ,bg4))))
   `(term-color-black ((,class (:foreground ,fg2 :background nil))))
   `(region ((,class (:extend t :background ,bg5))))
   `(highlight ((,class (:extend t :foreground ,fg1 :background ,bg5))))
   ...
   `(mode-line-inactive ((,class (:foreground ,fg3 :background ,bg1 :weight normal))))
   ...
   `(minibuffer-prompt ((,class (:bold t :foreground ,fg1 :background ,bg2))))
   ...
   `(magit-item-highlight ((,class :extend t :background ,bg4)))
   `(magit-section-heading        ((,class (:foreground ,keyword :weight bold))))
   `(magit-hunk-heading           ((,class (:extend t :background ,bg4))))
   `(magit-section-highlight      ((,class (:extend t :background ,bg3))))
   `(magit-hunk-heading-highlight ((,class (:extend t :background ,bg4))))
   `(magit-diff-context-highlight ((,class (:extend t :background ,bg4 :foreground ,fg3))))
   ...
   `(magit-diff-hunk-heading ((,class :extend t :background "grey35" :foreground "grey70")))
   `(magit-diff-context ((,class :extend t :background "grey20"  :foreground "grey70")))
   `(magit-diff-added ((,class :extend t :background "#336633" :foreground "#cceecc")))
   `(magit-diff-removed ((,class :extend t :background "#663333" :foreground "#eecccc")))
   `(magit-diff-hunk-heading-highlight ((,class :extend t :background "grey35" :foreground "grey70")))
   `(magit-diff-file-heading-highlight ((,class :extend t :inherit (magit-section-highlight))))
   `(magit-diff-context-highlight ((,class :extend t :background "grey20"  :foreground "grey70")))
   `(magit-diff-added-highlight ((,class :extend t :background "#336633" :foreground "#cceecc")))
   `(magit-diff-removed-highlight ((,class :extend t :background "#663333" :foreground "#eecccc")))
   `(lazy-highlight ((,class (:foreground ,bg1 :background ,fg3))))
   `(term ((,class (:foreground ,fg1 :background ,bg1))))
   `(term-color-black ((,class (:foreground ,bg4 :background ,bg3))))
   ...
   `(company-tooltip ((,class (:foreground ,fg4 :background ,bg2 :bold t))))
   `(company-tooltop-annotation ((,class (:foreground ,const))))
   `(company-tooltip-common ((,class (:foreground ,fg3))))
   `(company-tooltip-common-selection ((,class (:foreground ,fg1))))
   `(company-tooltip-mouse ((,class (:inherit highlight))))
   `(company-tooltip-selection ((,class (:foreground ,fg3 :background ,bg4))))
   `(company-template-field ((,class (:inherit region))))
   `(neo-dir-link-face ((,class (:foreground "#AEBDF9"))))
   `(neo-expand-btn-face ((,class (:foreground "#AEBDF9"))))
