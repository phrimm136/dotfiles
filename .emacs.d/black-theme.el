...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(line-number ((,class (:foreground ,fg3))))
   `(line-number-current-line ((,class (:foreground ,fg1 :background ,bg2))))
   ...
   `(org-block ((,class (:background ,bg3 :foreground ,fg1))))
   ...
   `(term-color-black ((,class (:foreground ,bg3 :background ,bg2))))
   ...
   `(company-tooltip-selection ((,class (:foreground ,fg3 :background ,bg2))))
   ...
   `(helm-swoop-target-line-face ((,class (:background ,bg3))))
